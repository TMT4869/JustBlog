        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortDescription = table.Column<string>(name: "Short Description", type: "nvarchar(750)", maxLength: 750, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommentHeader = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Articles related to lifestyle.", "Lifestyle", "lifestyle" },
                    { 2, "Articles related to technology.", "Technology", "technology" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 10, "Articles related to food.", "Food", "food" },
                    { 2, 6, "Articles related to AI.", "AI", "ai" },
                    { 3, 8, "Articles related to game.", "Game", "game" },
                    { 4, 5, "Articles related to anime.", "Anime", "anime" }
                });
